...
In this section we look at what impact a vote actually has on making the country and world a better place. Politics 101: a vote is helping to choose a winner between the parties you can vote for. Which means I should pick a party 🥳 that will result in a better world than the others. So far, so good 👍.
...
In the intro to this post, I talked about an uninformed vote being pointless or worse case actually going against what you're trying to achieve (by accidentally voting for a party that will do less good than the other party). So for an informed vote, you need to be informed (I know, pretty bold claim, right 🤪).
...
The world of politics and voting comes with such a strong cost 💰 for something that (at the moment) you can't reliably be sure will result in a better world than not voting. The major parties are all so similar on the grand scheme of things, the world is improving so much anyway and you really can't be sure what they'll do when voted in. So I really don't see a compelling reason to vote. I'm happy with any of the likely parties to win, the world still looks like it'll be amazing to me.
...
Everything I've said so far contributes to why I wouldn't vote for a specific party 🥳. However another option is to just spoil my vote. As it will then get counted in the total spoiled votes. Which can help show the country what the people are feeling about the parties or democratic system. However from everyone I've talked to and everything I've read about this, spoiled votes are considered protest votes, showing that people are unhappy with any of the options. This is not the case for me. I'm happy with any of the options. So I'm not sure that spoiling my vote will send an accurate message.
...
- If it was possible to reliably pick a party who will have a better impact than the others:
  - The research time needed to reliably pick a party who will have a better impact than the others would have a bigger difference on the world by being spent doing something else (such as earning more to give to charity, building products and companies that help the world)
